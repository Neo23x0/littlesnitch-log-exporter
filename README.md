...
```bash
prometheus:littlesnitch-log-exporter neo$ sudo littlesnitch  log-traffic -b '2021-01-02 11:00:00' | wc -l
   15709
prometheus:littlesnitch-log-exporter neo$ sudo python3 ./littlesnitch-log-exporter.py -m 60 | wc -l
     370
```
...
The idea is to schedule a log export, e.g. with a local cron job and syslog forwarding or using the script input of commercial agents like splunk's forwarder. 
